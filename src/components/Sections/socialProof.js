...
export default function SocialProof() {
  ...
  return (
    <motion.section
      ...
      className="w-full px-4 py-10 sm:py-14 md:py-16 lg:py-0"
    >
              ...
              {socials.map((social) => (
                <CarouselItem key={social.id}>
                  <div className="mx-auto text-center max-w-xl sm:max-w-2xl lg:max-w-4xl">
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-white font-mono mt-10">
                      {social.title}
                    </h2>
